<?php
session_start();
require_once "../../business/controllers/UserController.php";
            ...
            <div class="">
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control border-0 shadow py-3 px-4" name="keyword" placeholder="Search user...">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                                ...
                                <div class="mt-2"></div>
                                <tbody>                                    
                                    <?php if(count($user->getUsers()) > 0) : ?>
                                        <?php foreach($user->getUsers() as $index => $user) : ?>
                                            <tr>
                                    ...
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="4" class="text-center text-muted">No data user</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
