      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card border-0 shadow">
            <div class="card-body">
              <h5><img src="../assets/img/feedback.svg" alt="" width="30"> Add New Feedback</h5>
              <hr>
              <form action="" method="post">                
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea type="text" name="critics" id="critics" class="form-control" placeholder="Input your critics" rows="4"><?= isset($_POST['critics']) ? $_POST['critics'] : '' ?></textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea type="text" name="suggestion" id="suggestion" class="form-control" placeholder="Input your suggestion" rows="4"><?= isset($_POST['suggestion']) ? $_POST['suggestion'] : '' ?></textarea>
